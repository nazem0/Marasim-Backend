...
{
    public class ServiceAttachmentRepository : BaseRepository<ServiceAttachment>
    {
        private readonly EntitiesContext EntitiesContext;
        private readonly ServiceRepository ServiceManager;
        public ServiceAttachmentRepository(ServiceRepository _serviceManager, EntitiesContext _dBContext) : base(_dBContext)
        {
